...
//   [49.59, 5.29, 32.34, -10.01, 30.06, 13.01], C
  ...
  // [83.81, 0.23, 0.75, 0.64, 0.68, 1.00], //E----sad 1
...
//   [10.90, 0.12, 0.63, 0.60, 0.70, 0.77], A
  ...
  // [69.75, 3.19, 2.24, -0.65, -9.31, 1.00], //D---happy 0.75
//   [63.61, 5.58, -31.16, -20.03, -12.45, -17.43], C
  // [117.07, -21.58, 10.19, -0.28, 0.34, 21.21], //D------anger0.8
//   [80.92, -11.89, -17.89, -4.63, -13.33, -7.81], A

  // [76.98, 44.62, -15.93, 3.11, -7.96, -14.32], //B-----fear 0.7
//   [70.76, 36.66, -15.06, 29.02, 24.29, -4.90], B
  // [76.23, 13.03, 23.05, -0.08, -3.87, 13.26], //A-----anger0.7
//   [103.69, 9.20, 1.89, 6.65, -0.26, 29.09], C
//   [46.50, -4.67, -28.12, -6.47, -20.25, 50.37], B

  // [121.23, 31.73, 14.49, 20.81, 18.43, 19.98], //F anger
  // [94.72, 9.19, 1.70, -7.75, -2.97, -5.13], //G anger
  // [12.23, -21.10, -34.62, 12.23, 2.09, 43.19], //F fear
  // [-6.32, -35.59, -8.68, 3.48, -13.29, 27.86], //G ------fear0.7
  // [41.36, -0.06, -8.80, -0.28, 4.64, 1.44], //F sad---sad 1
  // [92.81, -0.31, -1.83, -6.83, 18.39, 1.98], //G sad
  // [17.87, 4.48, 12.86, 0.87, -11.17, 14.28], //F happy
  // [61.42, -1.39, 5.10, -1.24, 2.98, -5.43], //G -----happy 0.65
];
